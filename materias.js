export const DADOS_CURSO = {
    "1": [
        ...
        { id: '1P5', nome: 'Introdução a Ciência da Computação', creditos: 3, preRequisitos: {}, horarios: [{ dia: 2, slots: [0, 1, 2] }] },
        { id: '1P6', nome: 'Lógica para Computação', creditos: 3, preRequisitos: {}, horarios: [{ dia: 3, slots: [1, 2, 4] }] },
    ...
    "4": [
        { id: '4P1', nome: 'Equações Diferenciais Ordinárias I', creditos: 4, preRequisitos: { cursos: ['2P3', '3P2'] }, horarios: [{ dia: 3, slots: [10, 11] }, { dia: 4, slots: [10, 11] }] },
        { id: '4P2', nome: 'Eletromagnetismo', creditos: 5, preRequisitos: { cursos: ['2P4', '3P2'] }, horarios: [{ dia: 1, slots: [8, 9, 10, 11] }] },
    ...
    "5": [
        ...
        { id: '5P4', nome: 'Circuitos Lineares', creditos: 4, preRequisitos: { cursos: ['4P1', '4P2'] }, horarios: [{ dia: 1, slots: [6] }, { dia: 2, slots: [5, 6] }] },
        { id: '5P5', nome: 'Cálculo Numérico', creditos: 4, preRequisitos: { cursos: ['2P3', '2P6', '3P2'] }, horarios: [{ dia: 1, slots: [4, 5] }, { dia: 2, slots: [0, 1] }] },
        { id: '5P6', nome: 'Engenharia de Software', creditos: 2, preRequisitos: { cursos: ['2P6'] }, horarios: [{ dia: 2, slots: [5, 6] }] },
        { id: '5P7', nome: 'Programação Orientada a Objetos', creditos: 6, preRequisitos: { cursos: ['3P5'] }, horarios: [{ dia: 3, slots: [2, 4] }, { dia: 5, slots: [2, 4, 5, 6] }] }
    ],
    "6": [
        { id: '6P1', nome: 'Sinais e Sistemas', creditos: 4, preRequisitos: { cursos: ['2P3', '4P1'] }, horarios: [{ dia: 2, slots: [2, 4] }, { dia: 4, slots: [2, 4] }] },
        ...
        { id: '6P4', nome: 'Lab. de Circuitos Elétricos e Eletrônicos', creditos: 2, preRequisitos: { cursos: ['5P4'] }, horarios: [{ dia: 3, slots: [8, 9] }] },
        { id: '6P5', nome: 'Eletrônica Analógica', creditos: 4, preRequisitos: { cursos: ['5P4'] }, horarios: [{ dia: 1, slots: [2, 4] }, { dia: 2, slots: [0, 1] }] },
        { id: '6P6', nome: 'Linguagens Formais e Autômatos', creditos: 3, preRequisitos: { cursos: ['4P5'] }, horarios: [{ dia: 3, slots: [1, 2, 4] }] },
        { id: '6P7', nome: 'Análise de Algoritmos', creditos: 4, preRequisitos: { cursos: ['4P5'] }, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 5, slots: [0, 1] }] }
    ],
    "7": [
        { id: '7P1', nome: 'Técnicas Digitais', creditos: 6, preRequisitos: { cursos: ['6P4', '6P5'] }, horarios: [{ dia: 1, slots: [2, 4, 5] }, { dia: 3, slots: [1, 2, 4] }] },
        { id: '7P2', nome: 'Programação Linear', creditos: 4, preRequisitos: { cursos: ['5P5'] }, horarios: [{ dia: 1, slots: [0, 1] }, { dia: 2, slots: [2, 4] }] },
        { id: '7P3', nome: 'Processamento Digital de Sinais', creditos: 4, preRequisitos: { cursos: ['6P1'] }, horarios: [{ dia: 1, slots: [6, 8, 9] }, { dia: 2, slots: [5, 6] }] },
        { id: '7P4', nome: 'Metodologia Científica', creditos: 2, preRequisitos: { creditos: 162 }, horarios: [{ dia: 3, slots: [5, 6] }] }
    ],
    "8": [
        { id: '8P1', nome: 'Sistemas Distribuídos', creditos: 4, preRequisitos: { cursos: ['3P5', '5P2', '5P3'] }, horarios: [{ dia: 4, slots: [0, 1, 2, 4] }] },
        { id: '8P2', nome: 'Microcontroladores e Sistemas Embarcados', creditos: 4, preRequisitos: { cursos: ['3P4', '7P1'] }, horarios: [{ dia: 2, slots: [5, 6] }, { dia: 4, slots: [5, 6] }] },
        { id: '8P3', nome: 'Sistemas Inteligentes', creditos: 3, preRequisitos: { cursos: ['3P2', '5P1', '6P6'] }, horarios: [{ dia: 3, slots: [4, 5, 6] }] },
        { id: '8P4', nome: 'Computação Gráfica', creditos: 3, preRequisitos: { cursos: ['2P3', '5P7'] }, horarios: [{ dia: 1, slots: [4, 5, 6] }] },
    ...
    "9": [
        ...
        { id: '9P2', nome: 'Trabalho de Conclusão de Curso I', creditos: 2, preRequisitos: { cursos: ['7P4'] }, horarios: [{ dia: 2, slots: [0, 1] }] }
    ],
    "10": [
        { id: '10P1', nome: 'Trabalho de Conclusão de Curso II', creditos: 2, preRequisitos: { cursos: ['9P2'] }, horarios: [{ dia: 2, slots: [0, 1] }] }
    ],
    "optativas": [],
    "outros": []
};